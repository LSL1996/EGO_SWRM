...
/// 将得到的位置和ros::Time::now() - global_start_time_压入history_，若history_ 溢出，则删除最早的信息
...
/// 用拟合的方法预测每个障碍物的轨迹，把所有预测得到的轨迹、始末时间赋值给predict_trajs_
...
/// 将得到的msg保存到obj_scale_中的对应无人机处，并且scale_init_ 对应处设为true ，如果所有无人机的scale_init_ 中所有值都为true，怎关闭订阅该话题的订阅器
...
/// 认为无人机做匀速运动。取每架无人机最近获取到的两个点，得到多项式系数 p1*t+t0，为匀速直线运动
...
/// 用PolynomialPrediction::evaluateConstVel(double t) 返回obs_id 架无人机在time时刻的的速度
