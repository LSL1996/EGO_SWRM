...
namespace ego_planner
{
  ...
  public:
    ...
    PlanParameters pp_;
    LocalTrajData local_data_;  ///  包含id、耗时、开始时间、起点和位置、速度、加速度的均匀B样条函数类
    GlobalTrajData global_data_;
    GridMap::Ptr grid_map_;    /// 栅格地图类，接收深度/点云和位姿，发布地图
    fast_planner::ObjPredictor::Ptr obj_predictor_;    
    SwarmTrajData swarm_trajs_buf_;  ///所有无人机的轨迹，每个轨迹包含id、耗时、开始时间、起点和具体均匀B样条函数类
